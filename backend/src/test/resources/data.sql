...
insert into video(id, youtube_id, title, contents, creator_id, create_date, view_count, is_deleted) values(1, 'S8e1geEpnTA', '제목', '내용', 1, '2019-05-05 15:31:23', 100, false);
