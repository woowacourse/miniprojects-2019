...
public class MypageService {
    ...
    public MypageService(ArticleService articleService, UserService userService, CommentService commentService, LikesService likesService, FollowService followService) {
    ...
    public Page<MypageArticleDto> getMypageArticles(String userName, Pageable pageable) {
