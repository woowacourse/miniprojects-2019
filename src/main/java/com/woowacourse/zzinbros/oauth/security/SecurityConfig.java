...
import com.woowacourse.zzinbros.oauth.service.SocialService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(OAuth2ClientContext oauth2ClientContext, SocialService socialService, SocialLogoutHandler socialLogoutHandler) {
        this.oauth2ClientContext = oauth2ClientContext;
        this.socialService = socialService;
        this.socialLogoutHandler = socialLogoutHandler;
    }

    @Override
    protected void configure(HttpSecurity http) throws Exception {
        http.antMatcher("/oauth/**").authorizeRequests()
                .antMatchers("/", "/css/**", "/js/**", "/images/**", "/entrance", "/oauth/login", "/oauth/logout").permitAll()
