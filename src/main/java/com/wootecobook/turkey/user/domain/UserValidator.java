...
public class UserValidator {
    ...
    public static final String PASSWORD_CONSTRAINT_MESSAGE = "비밀번호는 , 소문자, 대문자, 숫자, 특수문자의 조합으로 입력하세요.";
    public static final String PASSWORD_LENGTH_CONSTRAINT_MESSAGE = "비밀번호 길이를 지켜주세요.(최소 8자)";
    ...
    public static void validatePassword(String password) {
        if (password.length() < MIN_PASSWORD_LENGTH) {
            throw new IllegalArgumentException(PASSWORD_LENGTH_CONSTRAINT_MESSAGE);
        }
