...
//    private static final Comment COMMENT2 = Comment.of(COMMENT_REQUEST2.getContents(), VIDEO, WRITER);
//    private static final Comment COMMENT3 = Comment.of(COMMENT_REQUEST3.getContents(), VIDEO, WRITER);
//
