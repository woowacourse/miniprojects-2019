...
public class UserControllerTest {
    ...
    @Test
    void login() {
        userRepository.save(new User("루피", "luffy2@luffy.com", "1234567a"));

        LogInRequestDto logInRequestDto = new LogInRequestDto("luffy2@luffy.com", "1234567a");
    ...
    void loginFailedNoUser() {
        userRepository.save(new User("루피", "luffy3@luffy.com", "1234567a"));
